...
export function SiteFooter() {
  ...
  return (
    <footer className="relative w-full">
      <Container
        size="2xl"
        className="text-muted-foreground relative flex flex-col items-center gap-10 py-10 text-sm lg:flex-row lg:justify-between lg:py-16"
      >
      ...
      <Container size="2xl" className="flex items-center justify-center pb-6">
