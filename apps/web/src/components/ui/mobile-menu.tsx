...
function MobileMenu({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Root>) {
  return <DrawerPrimitive.Root data-slot="drawer" {...props} />;
}

function MobileMenuNested({ ...props }: React.ComponentProps<typeof DrawerPrimitive.NestedRoot>) {
  return <DrawerPrimitive.NestedRoot data-slot="drawer-nested" {...props} />;
}

function MobileMenuTrigger({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Trigger>) {
  return <DrawerPrimitive.Trigger data-slot="drawer-trigger" {...props} />;
}

function MobileMenuPortal({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Portal>) {
...
function MobileMenuContent({
  ...
  return (
    <MobileMenuPortal data-slot="drawer-portal">
      <MobileMenuOverlay />
...
function MobileMenuHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function MobileMenuFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function MobileMenuDescription({
  className,
  ...props
